...
<div class="content-wrap">
  ...
  <div class="pay-cont">
      ...
      <div class="row1">
          <a href="pay_02.php"><button type="button" class="btn btn-lg btn-primary">コンビニ支払い</button></a>
      </div>

       <div class="row1">
          <a href="pay_02.php"><button type="button" class="btn btn-lg btn-info">クレジット支払い</button></a>
      </div>
  </div>     
 </div><!--content-wrap-->
</div><!--メインビジュアル-->
