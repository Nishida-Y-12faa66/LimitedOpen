...
$sql = "SELECT id FROM login WHERE user_id = '$yid';";
$result = mysqli_query($cn, $sql);
$row = mysqli_fetch_assoc($result);
$uid = $row['id'];
$sql = "SELECT product.exhibitor FROM trade INNER JOIN product ON trade.product_id = product.id;";
$result = mysqli_query($cn, $sql);
$row = mysqli_fetch_assoc($result);
$sid = $row['exhibitor'];
...
if(isset($_POST)){
  ...
  assessment($trade_id,$value,$comment,$uid,$sid);
