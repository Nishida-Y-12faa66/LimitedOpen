      ...
      <div class="mytop">
        ...
        <?php if($row['news_type'] == 1): ?>
          <div class="news-detail">
            ...
            <a href="./my-page.php" class="button">マイページへ戻る</a>
          </div>
        </div>
        <?php elseif($row['news_type'] == 7): ?>
          <div class="news-detail">
            <h2><?php echo $row['title']; ?></h2>
            <p class="">
              <?php foreach ($detail as $details) : ?>
        ...
        <?php elseif($row['news_type'] == 2): ?>
          <?php foreach($karrays as $karray): ?>
            <?php if($row['nego_id'] == $karray['id']): ?>
              <div class="contents-box">
                <div class="news-detail">
                  <h2><?php echo $row['title']; ?></h2>
                  <p>あなたが出品した「<?php echo $karray['name']; ?>」に対して、値下げ交渉が届きました。</p>
                  <br>
                  <p>交渉者：<?php echo $karray['user_id']; ?>さん</p>
                  <br>
                  <p>希望価格：<?php echo number_format($karray['price']); ?>円</p>
                  <br>
                  <a href="./my-page.php" class="button">マイページへ戻る</a>
                </div>
              </div>
