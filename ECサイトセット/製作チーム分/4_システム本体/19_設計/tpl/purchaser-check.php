          ...
          <div class="contents-box">
            <div class="news-detail">
              ...
              <form action="" method="post">
                <p class="kp">購入者：<?php echo $row['user_id']; ?></p>
                <p class="kp">取引金額：<?php echo number_format($row['price']); ?>円</p>
                <p class="kp kpp">これでよろしいですか？</p>
                <input type="submit" value="購入者を変更する" name="fix" class="button i">
                <input type="submit" value="購入者を確定する" name="confirm" class="button i" onclick="msgdsp()">
              </form>
            </div>
          </div>
