  ...
  <header>
    ...
    <nav id="header-bottom">
      <ul>
        ...
        <li id="notice"><a href="../my-page.php"><img src="./../images/bell.png" width="25px" height="auto"> <span
              class="word">お知らせ</a></li>
        <li id="my-page"><a href="../my-page.php"><img src="./../images/hito.png" width="25px" height="auto"> <span
